class TabElement extends HTMLElement {
	...
	static get observedAttributes() { return ['recall', 'oriendation']; }
	get recall() { return this.getAttribute('recall'); }
	get oriendation() { return this.getAttribute('oriendation'); }
	set oriendation(value) { this.setAttribute('oriendation', value); }
